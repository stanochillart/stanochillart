...
Other apps come with ads, missing features, and notifications that try to run the day. So I built my own. Clean. No ads. No tracking. Offline when it makes sense.

If one of them works for you, take it. If not, no problem.
...
The English name opens the English flyer. SK opens the Slovak one. Not the default README of another language.
